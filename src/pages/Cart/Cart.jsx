...
export const Cart = () => {
    ...
    return (
        <Box position={'relative'} bg='rgb(231, 246, 242)'>
            {
                cartData.length === 0 ?
                    <Box>
                        <Box w='30%' pt='20px'>
                            <Heading as='h4' color='rgb(57, 91, 100)' textAlign={'center'} fontSize='25px' fontWeight={'600'}>My Cart</Heading>
                        </Box>
                        <Box pb='20px'>
                            <Box m='70px 0 50px 0' display={'flex'} alignItems='center' justifyContent={'center'}>
                                <Box>
                                    ...
                                    <Center>
                                        <Text mt='10px' fontWeight={'400'} textAlign={'center'} color='rgb(57, 91, 100)' fontSize={'14px'} w='62%'>You have no items added in the cart. Explore and add products you like!</Text>
                                    </Center>
                                    <Center>
                                        <Button onClick={handleAddProducts} _hover='none' mt='20px' bg='#395B64' h='46px' fontSize={'15px'} color='rgb(231, 246, 242)' borderRadius={'3px'} w='70%'>ADD PRODUCTS</Button>
                                    </Center>
                                </Box>
                            </Box>
                            <Box mt='50px'>
                                <Box w='50%' p='15px' m='auto' borderRadius={'10px'} bg='rgb(231, 246, 242)'>
                                    {
                                        saveForLaterData ?
                                            <Box>
                                                {
                                                        ...
                                                        <Flex key={el.id} borderBottom='1px solid #dddde0' p='15px' gap='10px'>
                                                            ...
                                                            <Flex w='100%'>
                                                                <Box w='100%'>
                                                                    ...
                                                                    <Flex mt='20px'>
                                                                        <Button bg='rgb(57, 91, 100)' mr='10px' borderRadius={'3px'} fontSize={'12px'} color='rgb(165, 201, 202)' size='xs' _hover={'none'} letterSpacing={'1px'} onClick={() => removeCart(SaveForLater_API, el.id)}>REMOVE</Button>
                                                                        <Button bg='rgb(57, 91, 100)' color='rgb(165, 201, 202)' borderRadius={'3px'} fontSize={'12px'} size='xs' _hover={'none'} letterSpacing={'1px'} onClick={() => AddToCartFromSave(el)}>ADD TO CART</Button>
                                                                    </Flex>
                                                                </Box>
                                                                <Box w='20%'>
                                                                    <Center><Text fontWeight={'600'} color='#AC3F21'>Rs.{el.actual_price.toFixed(2)}</Text></Center>
                                ...
                                <Box bg='#fff' borderRadius={'7px'}>
                                    <Box p='15px'>
                                                    ...
                                                    <Box key={el.id} borderBottom='1px solid #dddde0' p='15px 0'>
                                                        ...
                                                        <Box ml={{ base: '20px', lg: '60px' }} mt='10px' display={'flex'} justifyContent='space-between' position={'relative'}>
                                                            <Box display={{ base: 'block', md: 'flex' }} alignItems={'flex-end'}>
                                                                <Text fontWeight={'600'} color='#AC3F21' mr='5px'>Rs. {parseFloat(el.actual_price).toFixed(2)}</Text>
                                                                {
                                        ...
                                        <Flex mt='15px' justifyContent={'space-between'}>
                                            <Text fontSize={'13px'} color='#395B64' fontWeight={'600'} letterSpacing='1px'>ADD MORE ITEMS</Text>
                                            <AddIcon cursor={'pointer'} onClick={handleAddMore} color="#395B64" />
                                        </Flex>
                                    </Box>
                                </Box>
                                                                ...
                                                                <Box w='100%'>
                                                                    <Box display={{ base: 'block', lg: 'flex' }} justifyContent='space-between'>
                                                                        ...
                                                                        <Box display={{ base: 'block', md: 'flex-column' }} >
                                                                            <Text fontWeight={'600'} color='#AC3F21'>Rs.{el.actual_price.toFixed(2)}</Text>
                                                                    ...
                                                                    <Flex mt='20px'>
                                                                        ...
                                                                        <Button bg='#395B64' color='#fff' borderRadius={'3px'} fontSize={'12px'} size='sm' _hover={'none'} letterSpacing={'1px'} onClick={() => AddToCartFromSave(el)}>ADD TO CART</Button>
                                                                    </Flex>
                                                                </Box>
                            ...
                            <Box w={{ base: '100%', lg: '45%' }}>
                                <Box p='10px' pb='20px' borderRadius={'5px'} bg='#fff' mb='15px'>
                                    <Box>
                                        ...
                                        <Checkbox onChange={() => handlePromo(showHidden)} colorScheme={'gray'}>Apply Promo Code</Checkbox>
                                    ...
                                    <Box mt='30px' pos='relative'>
                                        <Box ref={promeRef} display='none'>
                                            <Text color='#395B64' fontSize={'12px'} fontWeight='600'>PROMOCODE</Text>
                                            <Box>
                                                <Input onChange={(e) => setPromoCode(e.target.value)} size={'xs'} variant='flushed' placeholder='Have a promocode? Enter here' />
                                                <Button onClick={ApplyPromoCode} pos='absolute' right='0' bottom='-5px' bg='none' _hover='none' color='#AC3F21'>Apply</Button>
                                            </Box>
                                            {
                                ...
                                <Box p='10px' pb='20px' borderRadius={'5px'} bg='#fff' mb='15px'>
                                    ...
                                    <Box bg='#F5EDDC' p='10px 15px' mb='30px'>
                                        <Text fontSize={'12px'} fontWeight='600' color='#D1512D' letterSpacing='1px'>TOTAL SAVINGS RS.{parseFloat(discount).toFixed(2)}</Text>
                                    </Box>
                                    <Flex justifyContent={'space-between'} p='5px'>
                                        ...
                                        <Box>
                                            <Button onClick={handleProcced} bg='#395B64' borderRadius={'2px'} color='#fff' letterSpacing={'1px'} _hover='none' p='0 30px'>PROCEED</Button>
                                        </Box>
                                    </Flex>
                                </Box>
                                <Box mt='-20px' p='15px'>
