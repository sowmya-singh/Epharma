    ...
    return (
        <Box w={{ base: "100%", lg: "50%" }} ml={{ base: "20px" }} pr={{ base: "0", lg: "25px" }}>
            ...
            <Box display={"flex"} mt="10px" mb="20px">
                ...
                <Text display={"flex"} alignItems="center" mr="10px" color="#D1512D" fontSize={"15px"} fontWeight='700'>4.8
                    <AiFillStar />
                    <AiFillStar />
                    <AiFillStar />
                    <AiFillStar />
            ...
            <Button mt="20px" mb="15px" background={"#395B64"} color="white" _hover={{ bgColor: "#395B64" }} onClick={() => handleAdd(currProduct)}>ADD TO CART</Button>
            <hr />
            <Text color="#6f7284" fontSize={"15px"} fontWeight="600" mt="20px">Check Availability & Expiry</Text>
            <Box display={"flex"} alignItems={"flex-end"} borderBottom={"3px solid #395B64"} width="200px" pb="3px">
                <Text as='span' color={"#395B64"} fontWeight="700" fontSize={"16px"}>PINCODE:</Text>
                ...
                <HiArrowCircleRight color={"#395B64"} fontSize="30px" />
            </Box>
                ...
                <Box display={"flex"} mr="40px" mt="10px" background={"#f3f3f3"} p="15px" borderRadius={"10px"} justifyContent="space-between">
                    <Box display="flex" gap="20px">
                        ...
                        <Box display="flex" flexDirection={"column"} gap={"5px"}>
                            ...
                            <Text color="#D1512D" fontSize={"12px"} fontWeight="700">You get {discount}% OFF on this product</Text>
                        </Box>

                    </Box>
                    <Text color={"red"} fontSize="12px">Offer Applied</Text>
                </Box>
            </Box>}
