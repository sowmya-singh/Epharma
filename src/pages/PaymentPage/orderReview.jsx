  ...
  return (
    ...
    (
      ...
      <Flex >
              ...
              <Box ml="auto" w="90px" >
              <Box   ml="0px" >
                  <Text fontSize='14px' color='#ac3f21' >Rs.{post.actual_price}</Text>
            ...
            <Box   padding='10px' mb='60px' id='boxshadow'>
              <Flex justifyContent="space-between" >
                ...
                <Text fontSize='16px' color='#ac3f21' ><SlideAddress/></Text>
              </Flex>
        ...
        <Box   height='auto' padding='10px' id='boxshadow2' w={{base:"100%",lg:"50%"} } mt="20px">
            ...
            <Box bg='#F5EDDC' mt='20px' p='10px'>
              <Text color='#D1512D' fontSize='14px'> TOTAL SAVINGS   RS.{(discount+promoCodeDiscount).toFixed(2)}</Text>
            </Box>
