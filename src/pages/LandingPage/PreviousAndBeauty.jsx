    ...
    <Box p='8px 25px' m='20px 0' display={{base: 'none', md: 'flex'}}>
        <Flex w='100%' borderRight='1px solid rgb(181, 181, 181)' p='0 20px 0 0'>
            <Box >
                ...
                <Flex mt='40px'>
                    <Text color={'#395B64'} mr='30px' cursor={'pointer'}>View Orders</Text>
                    <Circle w='30px' h='30px' cursor={'pointer'} bg={'#2395B64'}><ChevronRightIcon color={'#fff'}/></Circle>
                </Flex>
            </Box>
            <Spacer/>
        ...
        <Flex w='100%' pl='20px'>
            <Box>
                ...
                <Text color='#C58940' fontWeight={'400'}>Save Upto 40% off</Text>
                <Flex>
                    <Button h='35px' letterSpacing={'1px'} borderRadius={'3px'} boxShadow= '0 6px 12px 0 rgb(36 174 177 / 40%)'  p='0 20px' bg='#395B64' color='#fff' _hover={{bg:'#395B64'}} fontSize='14px' mt='40px'>Explore Beauty</Button>
                </Flex>
            </Box>
            <Spacer />
            <Box display={'grid'} placeContent='center'>
