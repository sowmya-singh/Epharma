  ...
  return (
    <Menu isOpen={isOpen} isLazy={true} placement="bottom-end">
      ...
      <MenuList onMouseEnter={onOpen} onMouseLeave={onClose}>
        ...
        >
          <Box>
            <Text fontSize={"16px"} color='#ac3f21'>
          ...
          <Flex justifyContent={'center'} alignItems='center' bg="rgb(57, 91, 100)" height='40px' paddingInline='5px' borderRadius={'5px'}>
              <Text
